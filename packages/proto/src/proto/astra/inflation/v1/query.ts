 ...
 * source: astra/inflation/v1/query.proto
...
export namespace astra.inflation.v1 {
    export class QueryInflationPeriodRequest extends pb_1.Message {
        #one_of_decls = [];
        ...
        static fromObject(data: {}) {
            const message = new QueryInflationPeriodRequest({});
            return message;
        }
        toObject() {
            const data: {} = {};
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryInflationPeriodRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryInflationPeriodRequest();
        ...
        static deserializeBinary(bytes: Uint8Array): QueryInflationPeriodRequest {
            return QueryInflationPeriodRequest.deserialize(bytes);
        }
    }
    export class QueryInflationPeriodResponse extends pb_1.Message {
        #one_of_decls = [];
        constructor(data?: any[] | {
            period?: number;
        ...
        static fromObject(data: {
            ...
            const message = new QueryInflationPeriodResponse({});
            if (data.period != null) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.epochs_per_period !== undefined)
                writer.writeUint64(2, this.epochs_per_period);
            if (typeof this.epoch_identifier === "string" && this.epoch_identifier.length)
                writer.writeString(3, this.epoch_identifier);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryInflationPeriodResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryInflationPeriodResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.epochs_per_period = reader.readUint64();
                        break;
                    case 3:
        ...
        static deserializeBinary(bytes: Uint8Array): QueryInflationPeriodResponse {
            return QueryInflationPeriodResponse.deserialize(bytes);
        }
    }
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls = [];
        constructor(data?: any[] | {
            params?: dependency_4.astra.inflation.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_4.astra.inflation.v1.Params, 1) as dependency_4.astra.inflation.v1.Params;
        }
        set params(value: dependency_4.astra.inflation.v1.Params) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        static fromObject(data: {
            params?: ReturnType<typeof dependency_4.astra.inflation.v1.Params.prototype.toObject>;
        }) {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_4.astra.inflation.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_4.astra.inflation.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
